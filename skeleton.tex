...
not the same; therefore, the anonymity set can sometimes be either large or
...
The developed software, uses is based on Simpy\cite{simpy}, and realises many
...
Threshold Mixing and (c) stop-and-go mixing\cite{kesdogan1998stop} (i.e.
...
\emph{SonarQube} to get information about the quality of the code. In the first
...
results. We manage to partially replicate experiments because of hardware
limitations. As mentioned in chapter 4, our environment's RAM was caped to 16GB.
Nonetheless, our analysis revealed that, indeed anonymity of a Mixnet can be
